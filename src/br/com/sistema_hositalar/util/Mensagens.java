...
public class Mensagens {
    ...
    public static void informacao(String title, String message) {
    ...
    public static void Alerta(String title, String message) {
    ...
    public static void erro(String title, String message) {
...
//    }
    ...
    public static String Pergunta(String title, String message, String... options) {
